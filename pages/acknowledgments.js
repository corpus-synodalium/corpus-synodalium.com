    ...
    <>
        ...
        <p>
            ...
            <ul>
                ...
                <li>Arnaud Fossier (Université de Bourgogne)</li>
                <li>Maureen Miller (UC Berkeley)</li>
                <li>Bertil Nilsson (Göteborgs Universiteit)</li>
                <li>Fabrizio Pagnoni (Università degli Studi di Milano)</li>
            </ul>
        </p>
        ...
        <p>
            ...
            <ul>
                ...
                <li>
                    Maria Van Buiten, Department of History, Stanford University
                </li>
                <li>
                    Celena Allen, Center for Spatial and Textual Analysis,
                    Stanford University
                </li>
                <li>
                    Amanda Bergado, Center for Spatial and Textual Analysis,
                    Stanford University
                </li>
            </ul>
        </p>
